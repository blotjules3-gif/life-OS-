...
struct InterestChip: View {
    ...
    var body: some View {
        Button(action: onTap) {
            ...
            .frame(maxWidth: .infinity)
            .padding(.vertical, 10)
            .raisedSurface(RoundedRectangle(cornerRadius: 13, style: .continuous))
            .overlay(
...
// MARK: - Étape 5 & 6 (OnboardingResults, ModuleQuestion, OnboardingModuleSetup) → extraits dans LifeOS/Core/OnboardingResultsAndSetup.swift
