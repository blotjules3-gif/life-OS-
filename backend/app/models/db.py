...
class MobilityLog(Base):
    ...
    fuel_level_before: Mapped[float | None] = mapped_column(Numeric)
    fuel_level_after: Mapped[float | None] = mapped_column(Numeric)
...
class LifeChallenge(Base):
    ...
    daily_target: Mapped[float | None] = mapped_column(Numeric)
    unit: Mapped[str | None] = mapped_column(Text)
...
class DailyCheckin(Base):
    ...
    habits_done: Mapped[int | None] = mapped_column(Integer)
    habits_total: Mapped[int | None] = mapped_column(Integer)
    sport_minutes: Mapped[int | None] = mapped_column(Integer)
