...
[2026-07-01] | Onboarding poles ×5 | added real setup flows: Productivité (focus/pomodoro/screen), Mental (stress/meditation/screen), Looks (skin type/concerns/reminders), Cycle (start date/length), Mobilité (creates Vehicle, idempotent); registered in CategorySetup.flows + CategoryFlowView | builds yes
